...
contract Voting {
    ...
    VotingSession[] public votingHistory; //tableau qui va recueillir l'historique
    ...
    function tallyVotes() external onlyOwner {
        ...
        //on ajoute a tallyvotes() un historique de votes
        workflowStatus = WorkflowStatus.VotesTallied;
        votingHistory.push(VotingSession({
